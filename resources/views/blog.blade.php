...
<body x-data="{ test: 'Blog', nama: 'Fadhil Aditya' }" class="h-full">
    <div class="min-h-full">
        <nav class="bg-gray-800">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                ...
                                <el-menu anchor="bottom end" popover x-show="true"
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
                    <a href="#" aria-current="page"
                        class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Home page</a>
                    <a href="#"
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <!-- Your content -->
                <p>Haii ini adalah halaman {{ $title }}.</p>
            </div>
        </main>
    </div>
